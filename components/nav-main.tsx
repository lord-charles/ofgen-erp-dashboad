...
import { PlusIcon, Sparkles, type LucideIcon } from "lucide-react";
...
import { CreateProjectDrawer } from "@/app/projects/components/add-project";
...
export function NavMain({
  ...
  return (
    <>
        ...
        <SidebarGroupContent className="flex flex-col gap-1">
          <SidebarMenu>
            <SidebarMenuItem>
              ...
              >
                <PlusIcon className="transition-transform group-hover:scale-110 text-white" />
                <span className="font-medium text-white">New Project</span>
                <Sparkles className="ml-2 h-4 w-4 text-white relative left-16" />
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
      ...
      <CreateProjectDrawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen} />
    </>
  );
}
