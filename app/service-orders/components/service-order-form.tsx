...
export type ServiceOrderFormData = Omit<ServiceOrder, '_id' | 'createdAt' | 'updatedAt'>;
import { BillOfMaterialsSection } from "./bill-of-materials-section"
import { DesignSummarySection } from "./design-summary-section"
import { Building, MapPin, Phone, User, FileText, CheckCircle, List, ChevronsUpDown, Check } from "lucide-react"
...
export function ServiceOrderForm({ onSubmit, onCancel, defaultValues, isEditing = false, loading }: ServiceOrderFormProps) {
  ...
  const basicInfoHasErrors = getTabValidationStatus(['issuedBy', 'issuedTo', 'serviceOrderDate'])
  const contactHasErrors = getTabValidationStatus(['contactInfo.name', 'contactInfo.telephone', 'contactInfo.email', 'contactInfo.physicalAddress'])
  const locationHasErrors = getTabValidationStatus(['locationInfo.region', 'locationInfo.subRegion', 'locationInfo.coordinates.latitude', 'locationInfo.coordinates.longitude'])
  const siteHasErrors = getTabValidationStatus(['siteDetails.siteId', 'siteDetails.siteType', 'siteDetails.siteClassification'])


  const ComboboxSelect = ({ options, value, onChange, placeholder }: { options: { value: string; label: string }[], value: string, onChange: (value: string) => void, placeholder: string }) => {
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p >
                {isEditing ? "Update the service order details below" : "Fill in the details to create a new service order"}
              </p>
            </div>
            <Badge variant={watchedStatus === "approved" ? "default" : "secondary"} className="text-sm px-3 py-1">
              ...
              <div className=" rounded-lg shadow-sm border border-slate-200">
                  ...
                  <TabsList className="grid w-full grid-cols-7 h-auto p-2 bg-transparent">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {basicInfoHasErrors && <div className="w-2 h-2 bg-red-500 rounded-full" />}
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {contactHasErrors && <div className="w-2 h-2 bg-red-500 rounded-full" />}
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {locationHasErrors && <div className="w-2 h-2 bg-red-500 rounded-full" />}
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {siteHasErrors && <div className="w-2 h-2 bg-red-500 rounded-full" />}
                      </div>
                ...
                <div className="p-6">
                  ...
                  <TabsContent value="basic" className="m-0 space-y-6">
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="text-sm">Enter the fundamental details of the service order</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium">Issued By *</FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium">Issued To *</FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium">Service Order Date *</FormLabel>
                              <FormControl>
                                <Input
                                  type="date"
                                  {...field}
                  ...
                  <TabsContent value="contact" className="m-0 space-y-6">
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="text-sm">Contact details for the service order</p>
                      </div>
                  ...
                  <TabsContent value="location" className="m-0 space-y-6">
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="text-sm">Geographic location and coordinates</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium">Sub Region *</FormLabel>
                              <FormControl>
                                <Input
                  ...
                  <TabsContent value="site" className="m-0 space-y-6">
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="text-sm">Site identification and classification</p>
                      </div>
                      ...
                      <div className="space-y-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium">Site ID *</FormLabel>
                              <ComboboxSelect
                                options={locations.map(loc => ({ value: (loc?.siteId || loc?.systemSiteId) as string, label: `${loc?.name}-(${loc?.siteId || loc?.systemSiteId})` }))}
                                value={field.value}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-sm font-medium">Site Type</FormLabel>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  <FormControl>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-sm font-medium">Site Classification</FormLabel>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  <FormControl>
                                    <SelectTrigger className="h-11 focus:ring-2 focus:ring-orange-500/20">
                  ...
                  <TabsContent value="design" className="m-0 space-y-6">
                    <ScrollArea className="space-y-2 h-[50vh]">
                      <div>
                        <h2 className="text-xl font-semibold  mb-1">Design Summary</h2>
                      </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <DesignSummarySection designSummary={field.value} onChange={field.onChange} />
                            <FormMessage />
                          </FormItem>
                        )}
                      />
                  ...
                  <TabsContent value="bom" className="m-0 space-y-6">
                    <ScrollArea className="space-y-2 h-[50vh]">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <BillOfMaterialsSection items={field.value} onChange={field.onChange} />
                            <FormMessage />
                          </FormItem>
                        )}
                      />
                  ...
                  <TabsContent value="status" className="m-0 space-y-6">
                    <div className="space-y-6">
                      <div>
                        <h2 className="text-xl font-semibold  mb-2">Status & Additional Information</h2>
                        <p className="text-sm">Order status and additional comments</p>
                      </div>
                        ...
                        {watchedStatus === "approved" && (
                          <div className="bg-green-50 border border-green-200 rounded-lg p-6 space-y-4">
                            <div className="flex items-center gap-2 mb-4">
                              ...
                              <h3 className="text-lg font-medium text-green-900">Approval Information</h3>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel className="text-sm font-medium">Approval Date</FormLabel>
                                    <FormControl>
                                      <Input
                                        type="date"
                                        {...field}
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormLabel className="text-sm font-medium">Approval Comments</FormLabel>
                                  <FormControl>
                                    <Textarea
                ...
                <div className="border-t border-slate-200 rounded-b-lg px-6 py-4">
                  <div className="flex justify-end space-x-3">
                    ...
                    >
                      {isEditing ? <div>{loading ? <div className="flex items-center gap-2"><Spinner /> <span>Updating...</span></div> : "Update"}</div> : <div>{loading ? <div className="flex items-center gap-2"><Spinner /> <span>Creating...</span></div> : "Create Order"}</div>}
                    </Button>
                  </div>
                </div>
              </div>
